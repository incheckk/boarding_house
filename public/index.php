...
<style>
    ...
    * {
    ...
    .content-panel {
        display: none;
        max-height: 440px;
        /* Subtract padding from wrapper height */
        overflow-y: auto;
        overflow-x: hidden;
        padding-right: 15px;
    }
            ...
            <div class="content-wrapper">
                <div id="company" class="content-panel active">
                    <div class="content-text">
                        <p>Casa Villagracia Boarding House offers a safe, organized, and comfortable living environment
                            for students, employees, and individuals seeking an affordable and convenient place to stay.
                            Located in Almers, Tabok, Mandaue City, the boarding house is easily accessible to public
                            transportation, nearby schools, commercial establishments, and essential services—making it
                            an ideal home for residents who value comfort, accessibility, and a peaceful living setup.
                        </p>

                        <p>Established to provide secure, quality, and budget-friendly accommodation, Casa Villagracia
                            is committed to maintaining a clean and peaceful environment supported by proper facility
                            upkeep and a respectful community culture. To enhance tenant convenience, the boarding house
                            integrates a modern digital management system that streamlines bookings, payments, tenant
                            records, and maintenance requests.</p>
                ...
                <div id="terms" class="content-panel">
                    <div class="content-text">
                        <p>To ensure a safe, orderly, and harmonious living environment, all tenants must abide by the
                            following policies:</p>

                        <h3>1. REGISTRATION & MOVE-IN</h3>
                        <ul>
                            <li>All tenants must complete the Tenant Reservation Form and present at least one valid ID
                                in person.</li>
                            <li>A security deposit and one (1) month advance rent are required before move-in.</li>
                            <li>Only registered/approved tenants may occupy the room; no unauthorized overnight guests.
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>Only allowed appliances may be used inside rooms, such as electric fans, laptops, and
                                lights.</li>
                            <li>High-power appliances (induction cookers, heaters, microwaves, etc.) are not allowed
                                inside rooms.</li>
                        ...
                        <ul>
                            ...
                            <li>Management is not liable for lost or stolen personal items—tenants must secure their
                                belongings.</li>
